...
public class Level : MonoBehaviour {
    ...
    //private const float PIPE_MOVE_SPEED = 800f;
    ...
    private void HandleClouds() {
        ...
        if (Player.playerType == "Turtle"){
            cloudTransform.position += new Vector3(-1, 0, 0) * TurtleAttr.PIPE_MOVE_SPEED * Time.deltaTime * .7f;
		}
		else if(Player.playerType == "Bird"){
            cloudTransform.position += new Vector3(-1, 0, 0) * BirdAttr.PIPE_MOVE_SPEED * Time.deltaTime * .7f;
		}
		else if(Player.playerType == "Whale"){
            cloudTransform.position += new Vector3(-1, 0, 0) * WhaleAttr.PIPE_MOVE_SPEED * Time.deltaTime * .7f;
		}
    ...
    private void HandleGround() {
        ...
        if (Player.playerType == "Turtle"){
            groundTransform.position += new Vector3(-1, 0, 0) * TurtleAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
		else if(Player.playerType == "Bird"){
            groundTransform.position += new Vector3(-1, 0, 0) * BirdAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
		else if(Player.playerType == "Whale"){
            groundTransform.position += new Vector3(-1, 0, 0) * WhaleAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
    ...
    private void CreateObstacle(float height, float xPosition) {
        ...
        GameObject obstacle = Instantiate(GameAssets.GetInstance().pfObstacleGameObject[Random.Range(0,GameAssets.GetInstance().pfObstacleGameObject.Length)]);
    ...
    private class Obstacle {
        ...
        public void Move() {
        if (Player.playerType == "Turtle"){
             obstacleTransform.position += new Vector3(-1, 0, 0) * TurtleAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
		else if(Player.playerType == "Bird"){
             obstacleTransform.position += new Vector3(-1, 0, 0) * BirdAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
		else if(Player.playerType == "Whale"){
             obstacleTransform.position += new Vector3(-1, 0, 0) * WhaleAttr.PIPE_MOVE_SPEED * Time.deltaTime;
		}
        }
