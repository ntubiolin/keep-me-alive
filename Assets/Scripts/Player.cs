...
public class Player : MonoBehaviour {
	...
	void Start () {	
		...
		if (playerType == "Turtle"){
			standingPicPath = "Art/Player/turtle";
			crouchingPicPath = "Art/Player/turtle_attack";
			playerRigidbody2D.gravityScale = 50;
		}
		else if(playerType == "Bird"){
			standingPicPath = "Art/Player/bird";
			crouchingPicPath = "Art/player/bird_attack";
			playerRigidbody2D.gravityScale = 30;

		}
		else if(playerType == "Whale"){
			standingPicPath = "Art/Player/whale";
			crouchingPicPath = "Art/player/whale_attack";
			playerRigidbody2D.gravityScale = 20;
	...
	private void Jump() {
		if (playerType == "Turtle"){
        playerRigidbody2D.velocity = Vector2.up * TurtleAttr.JUMP_AMOUNT;
		}
		else if (playerType == "Bird"){
        playerRigidbody2D.velocity = Vector2.up * BirdAttr.JUMP_AMOUNT;
		}
		else if (playerType == "Whale"){
        playerRigidbody2D.velocity = Vector2.up * WhaleAttr.JUMP_AMOUNT;
		}
